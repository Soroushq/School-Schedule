        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <div className={`p-6 rounded-xl shadow-lg transition-all hover:shadow-xl ${
            ...
            <div className="flex flex-col items-center">
              <FaCalendarAlt className={`text-4xl mb-4 ${theme === 'dark' ? 'text-purple-400' : 'text-purple-600'}`} />
              <h2 className="text-xl font-bold mb-3">برنامه‌ریزی کلاسی</h2>
              <p className="text-center mb-4">
                برنامه‌ریزی ساعات کلاسی متوسطه دوم نظری
              </p>
              <Link 
                href="/education-levels/highschool/class-schedule"
          ...
          <div className={`p-6 rounded-xl shadow-lg transition-all hover:shadow-xl ${
            ...
            <div className="flex flex-col items-center">
              <FaUsers className={`text-4xl mb-4 ${theme === 'dark' ? 'text-purple-400' : 'text-purple-600'}`} />
              <h2 className="text-xl font-bold mb-3">برنامه‌ریزی پرسنلی</h2>
              <p className="text-center mb-4">
                برنامه‌ریزی ساعات کاری پرسنل متوسطه دوم نظری
              </p>
              <Link 
                href="/education-levels/highschool/personnel-schedule"
                className={`inline-block w-full text-center px-6 py-3 rounded-lg font-medium transition-all ${
                  theme === 'dark'
                    ? 'bg-purple-600 text-white hover:bg-purple-700'
                    : 'bg-purple-500 text-white hover:bg-purple-600'
