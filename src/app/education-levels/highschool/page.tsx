...
export default function HighSchoolPage() {
  ...
  useEffect(() => {
    ...
    // ذخیره مقطع انتخاب شده در localStorage
    localStorage.setItem('selectedLevel', EDUCATION_LEVELS.HIGH_SCHOOL);
  }, []);
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <div className={`p-6 rounded-xl shadow-lg transition-all hover:shadow-xl ${
            ...
            <div className="flex flex-col items-center">
              <FaCalendarAlt className={`text-4xl mb-4 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`} />
              <h2 className="text-xl font-bold mb-3">برنامه‌ریزی کلاسی</h2>
              <p className="text-center mb-4">
                برنامه‌ریزی ساعات کلاسی متوسطه دوم
              </p>
              <Link 
                href="/class-schedule/select-class"
          ...
          <div className={`p-6 rounded-xl shadow-lg transition-all hover:shadow-xl ${
            ...
            <div className="flex flex-col items-center">
              <FaUsers className={`text-4xl mb-4 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`} />
              <h2 className="text-xl font-bold mb-3">برنامه‌ریزی پرسنلی</h2>
              <p className="text-center mb-4">
                برنامه‌ریزی ساعات کاری پرسنل متوسطه دوم
              </p>
              <Link 
      ...
      {/* لودر مقطع تحصیلی */}
      <EducationLevelLoader onLevelLoaded={() => {}} />
    </div>
  );
} 